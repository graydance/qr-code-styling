...
// 赤焰猎心
export default class RedFlame implements Base {
  hasText: boolean;
  sWidth: number;
  sHeight: number;
  x: number;
  ...
  constructor(options: RequiredOptions) {
    ...
    this.sWidth = 660; // 二维码 宽
    this.sHeight = 660; // 二维码 高
    this.x = 172; // 插入二维码 x 坐标
    this.y = 172; // 插入二维码 y 坐标
