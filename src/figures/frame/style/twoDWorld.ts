 ...
 * @LastEditTime: 2022-06-10 16:23:29
...
// 二维世界
export default class twoDWorld implements Base {
  hasText: boolean;
  sWidth: number;
  sHeight: number;
  x: number;
  ...
  constructor(options: RequiredOptions) {
    ...
    this.sWidth = 590; // 二维码 宽
    this.sHeight = 590; // 二维码 高
    this.x = 205; // 插入二维码 x 坐标
    this.y = 205; // 插入二维码 y 坐标
