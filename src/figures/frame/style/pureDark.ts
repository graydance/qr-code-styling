 ...
 * @Date: 2022-06-10 16:46:43
 * @LastEditors: zhouQiang zhouqiang195@gmail.com
 * @LastEditTime: 2022-06-10 16:50:27
 * @FilePath: /qr-code-styling/src/figures/frame/style/pureDark.ts
...
// 纯深色
export default class PureDark implements Base {
  hasText: boolean;
  sWidth: number;
  sHeight: number;
  x: number;
  ...
  constructor(options: RequiredOptions) {
    ...
    this.sWidth = 685; // 二维码 宽
    this.sHeight = 685; // 二维码 高
    this.x = 160; // 插入二维码 x 坐标
    this.y = 160; // 插入二维码 y 坐标
