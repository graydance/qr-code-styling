...
// 紫色魅影
export default class PurplePerson implements Base {
  hasText: boolean;
  sWidth: number;
  sHeight: number;
  x: number;
  ...
  constructor(options: RequiredOptions) {
    ...
    this.sWidth = 580; // 二维码 宽
    this.sHeight = 580; // 二维码 高
    this.x = 215; // 插入二维码 x 坐标
    this.y = 207; // 插入二维码 y 坐标
